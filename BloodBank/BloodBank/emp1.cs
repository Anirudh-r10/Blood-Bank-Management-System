...
namespace BloodBank
{
    public partial class emp1 : Form
    {
        ...
        private void guna2Button3_Click(object sender, EventArgs e)
        {
            ...
            else if (!System.Text.RegularExpressions.Regex.IsMatch(enameTb.Text, "^[a-zA-Z ]"))
            {
                MessageBox.Show("This textbox accepts only alphabetical characters!");
            }

            else if (!System.Text.RegularExpressions.Regex.IsMatch(EphTxt.Text, "^[0-9]{10}"))
            {
        ...
        private void emp1_Load(object sender, EventArgs e)
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from Employee", con);
            DataSet ds = new DataSet();
